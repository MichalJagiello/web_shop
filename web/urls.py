...
urlpatterns = [
    ...
    url(r'krok_4/$', ThirdAndQuaterStepView.as_view(), name='krok_4'),
    url(r'krok_5/$', ThirdAndHalfStepView.as_view(), name='krok_5'),
    url(r'krok_6/$', FourthStepView.as_view(), name='krok_6'),
    ...
    url(r'pdf_prefabrykat/(?P<prefabricate_index>\d+)/$', PrintPrefabricatePdfFileView.as_view(), name='pdf_prefabrykat'),
